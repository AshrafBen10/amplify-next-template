...
export const auth = defineAuth({
  loginWith: {
    ...
    externalProviders: {
      ...
      callbackUrls: ["https://be1748a04fef8dfa848d.auth.us-west-2.amazoncognito.com", "http://localhost:3000/", "https://www.dev.chatbot.metalmental.net"],
      logoutUrls: ["https://be1748a04fef8dfa848d.auth.us-west-2.amazoncognito.com", "http://localhost:3000/", "https://www.dev.chatbot.metalmental.net"],
